      ...
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full">
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 text-sm"
        ...
        <div className="px-6 py-4 border-t bg-gray-50 flex justify-end gap-3">
          <button
            ...
            className="px-4 py-2 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100 font-medium text-sm transition-colors"
          >
            Close
          </button>
          <button
