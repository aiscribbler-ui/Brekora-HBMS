    ...
    <div className="max-w-5xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-lg border border-gray-200">
          ...
          <p className="mt-3 text-sm text-gray-500">No room types found.</p>
          <button
            onClick={() => navigate(`/properties/${propertyId}/room-types/new`)}
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Default Rate</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {roomTypes.map((rt) => (
                  <tr key={rt.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600">{rt.count}</td>
                    <td className="px-4 py-3 text-sm text-gray-600">
                      {rt.base_capacity} / {rt.max_capacity}
                    </td>
                    <td className="px-4 py-3 text-sm text-gray-600">{rt.default_rate}</td>
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="inline-flex items-center gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-md bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-1"
            ...
            {roomTypes.map((rt) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium text-gray-900">{rt.name}</h3>
                  {rt.is_archived ? (
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800">
                      Archived
                    </span>
