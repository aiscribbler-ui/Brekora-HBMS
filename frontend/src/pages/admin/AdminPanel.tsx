    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex flex-col gap-6 md:flex-row">
          ...
          <nav aria-label="Admin tabs" className="shrink-0 overflow-x-auto border-b border-gray-200 dark:border-gray-700 pb-2 md:w-64 md:border-b-0 md:border-r dark:md:border-gray-700 md:pr-4 md:pb-0">
          ...
          <div className="flex-1">
            <div className="rounded-xl bg-white dark:bg-gray-800 p-6 shadow-sm dark:shadow-gray-900/50">
              <ActiveComponent />
            </div>
          </div>
        </div>
