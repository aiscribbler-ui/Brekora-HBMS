    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Welcome to Brekora</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Complete the one-time setup to get started</p>
        </div>

        <form
          onSubmit={handleSubmit}
          className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 space-y-4"
        >
          {globalError && (
            <div className="p-3 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 rounded-lg border border-red-200 dark:border-red-800 text-sm" role="alert">
              {globalError}
            </div>
          )}
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 dark:bg-gray-800 dark:text-gray-100"
          ...
          <div>
            ...
            />
            {errors.adminName && <p className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.adminName}</p>}
          </div>
          ...
          <div>
            ...
            />
            {errors.adminEmail && <p className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.adminEmail}</p>}
          </div>
          ...
          <div>
            ...
            {errors.adminPassword && (
              <p className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.adminPassword}</p>
            )}
          </div>
